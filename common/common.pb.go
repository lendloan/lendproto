...
const (
	CertType_cert_type_ID    CertType = 0 // 身份证实名
	CertType_cert_type_FACE  CertType = 1 // 刷脸实名
	CertType_cert_type_THRID CertType = 2 // 第三方实名
)
...
type LendLoan_Status int32

const (
	LendLoan_Status_WAIT_LOAN       LendLoan_Status = 0 // 创建状态
	LendLoan_Status_ALREADY_LOAN    LendLoan_Status = 1 // 已经借出
	LendLoan_Status_ALREADY_FINISH  LendLoan_Status = 2 // 已经完成
	LendLoan_Status_ALREADY_EXPIRE  LendLoan_Status = 4 // 已经过期
	LendLoan_Status_ALREADY_INVALID LendLoan_Status = 8 // 已经无效
)

// Enum value maps for LendLoan_Status.
var (
	LendLoan_Status_name = map[int32]string{
		0: "WAIT_LOAN",
		1: "ALREADY_LOAN",
		2: "ALREADY_FINISH",
		4: "ALREADY_EXPIRE",
	...
	LendLoan_Status_value = map[string]int32{
		"WAIT_LOAN":       0,
		"ALREADY_LOAN":    1,
		"ALREADY_FINISH":  2,
		"ALREADY_EXPIRE":  4,
...
func (x LendLoan_Status) Enum() *LendLoan_Status {
	p := new(LendLoan_Status)
	*p = x
	return p
}

func (x LendLoan_Status) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (LendLoan_Status) Descriptor() protoreflect.EnumDescriptor {
	return file_common_proto_enumTypes[9].Descriptor()
}

func (LendLoan_Status) Type() protoreflect.EnumType {
	return &file_common_proto_enumTypes[9]
}

func (x LendLoan_Status) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use LendLoan_Status.Descriptor instead.
func (LendLoan_Status) EnumDescriptor() ([]byte, []int) {
...
const (
	StrategyType_Verify_None       StrategyType = 0 // 不需要验证
	StrategyType_Verify_PASS       StrategyType = 1 // 密码验证
	StrategyType_Verify_Sms_Code   StrategyType = 2 // 手机验证码
	StrategyType_Verify_Image_Code StrategyType = 3 // 图像验证码
)
...
type PersonCert struct {
	...
	CertType   CertType          `protobuf:"varint,7,opt,name=cert_type,json=certType,proto3,enum=common.CertType" json:"cert_type,omitempty"`
...
func (x *PersonCert) GetCertType() CertType {
	if x != nil {
		return x.CertType
	}
	return CertType_cert_type_ID
}
...
type ShareImage struct {
	...
	Stype int64  `protobuf:"varint,3,opt,name=stype,proto3" json:"stype,omitempty"` // 注意是针对我的物品而存在
}

func (x *ShareImage) Reset() {
	*x = ShareImage{}
	if protoimpl.UnsafeEnabled {
...
func (x *ShareImage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ShareImage) ProtoMessage() {}

func (x *ShareImage) ProtoReflect() protoreflect.Message {
	mi := &file_common_proto_msgTypes[29]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ShareImage.ProtoReflect.Descriptor instead.
func (*ShareImage) Descriptor() ([]byte, []int) {
	return file_common_proto_rawDescGZIP(), []int{29}
}

func (x *ShareImage) GetImage() string {
	if x != nil {
		return x.Image
	}
	return ""
...
func (x *ShareImage) GetThumb() string {
	if x != nil {
		return x.Thumb
	}
	return ""
...
func (x *ShareImage) GetStype() int64 {
	if x != nil {
		return x.Stype
	}
	return 0
...
type ShareItem struct {
	...
	FromUser   string        `protobuf:"bytes,6,opt,name=from_user,json=fromUser,proto3" json:"from_user,omitempty"`
	FromAvatar string        `protobuf:"bytes,7,opt,name=from_avatar,json=fromAvatar,proto3" json:"from_avatar,omitempty"`
	Title      string        `protobuf:"bytes,8,opt,name=title,proto3" json:"title,omitempty"`
	Mtype      int64         `protobuf:"varint,9,opt,name=mtype,proto3" json:"mtype,omitempty"`
	Media      []*ShareImage `protobuf:"bytes,10,rep,name=media,proto3" json:"media,omitempty"`
	...
	IsSelf     bool          `protobuf:"varint,13,opt,name=is_self,json=isSelf,proto3" json:"is_self,omitempty"`
	IsEdit     bool          `protobuf:"varint,14,opt,name=is_edit,json=isEdit,proto3" json:"is_edit,omitempty"`
}
...
func (x *ShareItem) GetUser() string {
	if x != nil {
		return x.User
	}
	return ""
...
func (x *ShareItem) GetAvatar() string {
	if x != nil {
		return x.Avatar
	}
	return ""
...
func (x *ShareItem) GetFromUid() int64 {
	if x != nil {
		return x.FromUid
	}
	return 0
...
func (x *ShareItem) GetFromUser() string {
	if x != nil {
		return x.FromUser
	}
	return ""
...
func (x *ShareItem) GetFromAvatar() string {
	if x != nil {
		return x.FromAvatar
	}
	return ""
...
func (x *ShareItem) GetTitle() string {
	if x != nil {
		return x.Title
	}
	return ""
...
func (x *ShareItem) GetMtype() int64 {
	if x != nil {
		return x.Mtype
	}
	return 0
...
func (x *ShareItem) GetMedia() []*ShareImage {
	if x != nil {
		return x.Media
	}
	return nil
...
func (x *ShareItem) GetCreateAt() int64 {
	if x != nil {
		return x.CreateAt
	}
	return 0
...
func (x *ShareItem) GetUpdateAt() int64 {
	if x != nil {
		return x.UpdateAt
	}
	return 0
...
func (x *ShareItem) GetIsSelf() bool {
	if x != nil {
		return x.IsSelf
	}
	return false
...
func (x *ShareItem) GetIsEdit() bool {
	if x != nil {
		return x.IsEdit
	}
	return false
...
func (x *TemplateItem) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *TemplateItem) GetTemplate() string {
	if x != nil {
		return x.Template
	}
	return ""
...
func (x *TemplateItem) GetCreateAt() int64 {
	if x != nil {
		return x.CreateAt
	}
	return 0
...
func (x *TemplateItem) GetUpdateAt() int64 {
	if x != nil {
		return x.UpdateAt
	}
	return 0
...
func (x *TemplateItem) GetExtra() map[string]string {
	if x != nil {
		return x.Extra
	}
	return nil
...
func (x *MeGoodsCategory) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MeGoodsCategory) ProtoMessage() {}

func (x *MeGoodsCategory) ProtoReflect() protoreflect.Message {
	mi := &file_common_proto_msgTypes[32]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MeGoodsCategory.ProtoReflect.Descriptor instead.
func (*MeGoodsCategory) Descriptor() ([]byte, []int) {
	return file_common_proto_rawDescGZIP(), []int{32}
}

func (x *MeGoodsCategory) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *MeGoodsCategory) GetUid() int64 {
	if x != nil {
		return x.Uid
	}
	return 0
...
func (x *MeGoodsCategory) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *MeGoodsCategory) GetIcon() string {
	if x != nil {
		return x.Icon
	}
	return ""
...
func (x *MeGoodsCategory) GetCreateAt() int64 {
	if x != nil {
		return x.CreateAt
	}
	return 0
...
type MeGoods struct {
	...
	Media    []*ShareImage `protobuf:"bytes,6,rep,name=media,proto3" json:"media,omitempty"`
...
func (x *MeGoods) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MeGoods) ProtoMessage() {}

func (x *MeGoods) ProtoReflect() protoreflect.Message {
	mi := &file_common_proto_msgTypes[33]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MeGoods.ProtoReflect.Descriptor instead.
func (*MeGoods) Descriptor() ([]byte, []int) {
	return file_common_proto_rawDescGZIP(), []int{33}
}

func (x *MeGoods) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *MeGoods) GetCateId() int64 {
	if x != nil {
		return x.CateId
	}
	return 0
...
func (x *MeGoods) GetMedia() []*ShareImage {
	if x != nil {
		return x.Media
	}
	return nil
...
func (x *MeGoods) GetStatus() int64 {
	if x != nil {
		return x.Status
	}
	return 0
...
func (x *MeGoods) GetExtra() string {
	if x != nil {
		return x.Extra
	}
	return ""
...
func (x *MeGoods) GetCreateAt() int64 {
	if x != nil {
		return x.CreateAt
	}
	return 0
...
type LendLoan struct {
	...
	Images   []*ShareImage     `protobuf:"bytes,6,rep,name=images,proto3" json:"images,omitempty"`
	Total    int64             `protobuf:"varint,7,opt,name=total,proto3" json:"total,omitempty"`
	Location string            `protobuf:"bytes,8,opt,name=location,proto3" json:"location,omitempty"`
	NdIp     string            `protobuf:"bytes,9,opt,name=nd_ip,json=ndIp,proto3" json:"nd_ip,omitempty"`
	AnIp     string            `protobuf:"bytes,10,opt,name=an_ip,json=anIp,proto3" json:"an_ip,omitempty"`
	NdDvid   string            `protobuf:"bytes,11,opt,name=nd_dvid,json=ndDvid,proto3" json:"nd_dvid,omitempty"`
	AnDvid   string            `protobuf:"bytes,12,opt,name=an_dvid,json=anDvid,proto3" json:"an_dvid,omitempty"`
	Status   int64             `protobuf:"varint,13,opt,name=status,proto3" json:"status,omitempty"`
	Expire   int64             `protobuf:"varint,14,opt,name=expire,proto3" json:"expire,omitempty"`
...
func (x *LendLoan) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LendLoan) ProtoMessage() {}

func (x *LendLoan) ProtoReflect() protoreflect.Message {
	mi := &file_common_proto_msgTypes[34]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LendLoan.ProtoReflect.Descriptor instead.
func (*LendLoan) Descriptor() ([]byte, []int) {
	return file_common_proto_rawDescGZIP(), []int{34}
}

func (x *LendLoan) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *LendLoan) GetNdUid() int64 {
	if x != nil {
		return x.NdUid
	}
	return 0
...
func (x *LendLoan) GetAnUid() int64 {
	if x != nil {
		return x.AnUid
	}
	return 0
...
func (x *LendLoan) GetGuid() string {
	if x != nil {
		return x.Guid
	}
	return ""
...
func (x *LendLoan) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *LendLoan) GetImages() []*ShareImage {
	if x != nil {
		return x.Images
	}
	return nil
...
func (x *LendLoan) GetTotal() int64 {
	if x != nil {
		return x.Total
	}
	return 0
...
func (x *LendLoan) GetLocation() string {
	if x != nil {
		return x.Location
	}
	return ""
...
func (x *LendLoan) GetNdIp() string {
	if x != nil {
		return x.NdIp
	}
	return ""
...
func (x *LendLoan) GetAnIp() string {
	if x != nil {
		return x.AnIp
	}
	return ""
...
func (x *LendLoan) GetNdDvid() string {
	if x != nil {
		return x.NdDvid
	}
	return ""
...
func (x *LendLoan) GetAnDvid() string {
	if x != nil {
		return x.AnDvid
	}
	return ""
...
func (x *LendLoan) GetStatus() int64 {
	if x != nil {
		return x.Status
	}
	return 0
...
func (x *LendLoan) GetExpire() int64 {
	if x != nil {
		return x.Expire
	}
	return 0
...
func (x *LendLoan) GetCreateAt() int64 {
	if x != nil {
		return x.CreateAt
	}
	return 0
...
func (x *LendLoan) GetUpdateAt() int64 {
	if x != nil {
		return x.UpdateAt
	}
	return 0
...
func (x *LendLoan) GetExtra() map[string]string {
	if x != nil {
		return x.Extra
	}
	return nil
...
type LendLoanGather struct {
	...
	Id          int64             `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`
	Desc        string            `protobuf:"bytes,2,opt,name=desc,proto3" json:"desc,omitempty"`
	NdUid       int64             `protobuf:"varint,3,opt,name=nd_uid,json=ndUid,proto3" json:"nd_uid,omitempty"`
	AnUid       int64             `protobuf:"varint,4,opt,name=an_uid,json=anUid,proto3" json:"an_uid,omitempty"`
	LlIds       string            `protobuf:"bytes,5,opt,name=ll_ids,json=llIds,proto3" json:"ll_ids,omitempty"`
	...
	Credentials string            `protobuf:"bytes,9,opt,name=credentials,proto3" json:"credentials,omitempty"`
	Signature   string            `protobuf:"bytes,10,opt,name=signature,proto3" json:"signature,omitempty"`
	RetImages   []*ShareImage     `protobuf:"bytes,12,rep,name=ret_images,json=retImages,proto3" json:"ret_images,omitempty"`
	RetInfos    string            `protobuf:"bytes,13,opt,name=ret_infos,json=retInfos,proto3" json:"ret_infos,omitempty"`
...
func (x *LendLoanGather) GetDesc() string {
	if x != nil {
		return x.Desc
	}
	return ""
...
func (x *LendLoanGather) GetRetImages() []*ShareImage {
	if x != nil {
		return x.RetImages
	}
	return nil
...
type Gather struct {
	...
	Status     int64           `protobuf:"varint,2,opt,name=status,proto3" json:"status,omitempty"`                          // 聚集的状态
	UserInfo   *UserInfo       `protobuf:"bytes,3,opt,name=user_info,json=userInfo,proto3" json:"user_info,omitempty"`       // 用户信息(非自己的)
	GatherInfo *LendLoanGather `protobuf:"bytes,4,opt,name=gather_info,json=gatherInfo,proto3" json:"gather_info,omitempty"` // 聚集信息
	Lendloans  []*LendLoan     `protobuf:"bytes,5,rep,name=lendloans,proto3" json:"lendloans,omitempty"`                     // 借入借出项
...
func (x *Gather) GetUserInfo() *UserInfo {
	if x != nil {
		return x.UserInfo
	}
	return nil
...
func (x *Gather) GetGatherInfo() *LendLoanGather {
	if x != nil {
		return x.GatherInfo
	}
	return nil
...
func (x *Gather) GetLendloans() []*LendLoan {
	if x != nil {
		return x.Lendloans
	}
	return nil
...
func (x *ShareVisi) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ShareVisi) ProtoMessage() {}

func (x *ShareVisi) ProtoReflect() protoreflect.Message {
	mi := &file_common_proto_msgTypes[38]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ShareVisi.ProtoReflect.Descriptor instead.
func (*ShareVisi) Descriptor() ([]byte, []int) {
	return file_common_proto_rawDescGZIP(), []int{38}
}

func (x *ShareVisi) GetUid() int64 {
	if x != nil {
		return x.Uid
	}
	return 0
...
type Strategy struct {
	...
	Type   StrategyType      `protobuf:"varint,1,opt,name=type,proto3,enum=common.StrategyType" json:"type,omitempty"` // 策略类型
	Title  string            `protobuf:"bytes,2,opt,name=title,proto3" json:"title,omitempty"`                         // 策略标题
	Info   string            `protobuf:"bytes,3,opt,name=info,proto3" json:"info,omitempty"`                           // 策略信息
	Detail string            `protobuf:"bytes,4,opt,name=detail,proto3" json:"detail,omitempty"`                       // 策略明细
	Notify string            `protobuf:"bytes,5,opt,name=notify,proto3" json:"notify,omitempty"`                       // 路由
	Style  string            `protobuf:"bytes,6,opt,name=style,proto3" json:"style,omitempty"`                         // dialog/page/toast
...
func (x *Strategy) GetType() StrategyType {
	...
	return StrategyType_Verify_None
}
...
func (x *Strategy) GetNotify() string {
	if x != nil {
		return x.Notify
	}
	return ""
...
func (x *Strategy) GetStyle() string {
	if x != nil {
		return x.Style
	}
	return ""
...
type GoodsTotal struct {
	...
	Media    []*ShareImage     `protobuf:"bytes,7,rep,name=media,proto3" json:"media,omitempty"`
...
func (x *GoodsTotal) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GoodsTotal) ProtoMessage() {}

func (x *GoodsTotal) ProtoReflect() protoreflect.Message {
	mi := &file_common_proto_msgTypes[40]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GoodsTotal.ProtoReflect.Descriptor instead.
func (*GoodsTotal) Descriptor() ([]byte, []int) {
	return file_common_proto_rawDescGZIP(), []int{40}
}

func (x *GoodsTotal) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *GoodsTotal) GetUid() int64 {
	if x != nil {
		return x.Uid
	}
	return 0
...
func (x *GoodsTotal) GetCateId() int64 {
	if x != nil {
		return x.CateId
	}
	return 0
...
func (x *GoodsTotal) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *GoodsTotal) GetIntro() string {
	if x != nil {
		return x.Intro
	}
	return ""
...
func (x *GoodsTotal) GetPrice() int64 {
	if x != nil {
		return x.Price
	}
	return 0
...
func (x *GoodsTotal) GetMedia() []*ShareImage {
	if x != nil {
		return x.Media
	}
	return nil
...
func (x *GoodsTotal) GetCreateAt() int64 {
	if x != nil {
		return x.CreateAt
	}
	return 0
...
func (x *GoodsTotal) GetUpdateAt() int64 {
	if x != nil {
		return x.UpdateAt
	}
	return 0
...
func (x *GoodsTotal) GetExtra() map[string]string {
	if x != nil {
		return x.Extra
	}
	return nil
...
var file_common_proto_rawDesc = []byte{
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xbe, 0x01, 0x0a, 0x08, 0x55, 0x73,
	...
	0x01, 0x28, 0x03, 0x52, 0x03, 0x76, 0x69, 0x70, 0x12, 0x10, 0x0a, 0x03, 0x75, 0x69, 0x64, 0x18,
	0x08, 0x20, 0x01, 0x28, 0x03, 0x52, 0x03, 0x75, 0x69, 0x64, 0x22, 0xf8, 0x01, 0x0a, 0x0e, 0x57,
	0x65, 0x63, 0x68, 0x61, 0x74, 0x55, 0x73, 0x65, 0x72, 0x69, 0x6e, 0x66, 0x6f, 0x12, 0x16, 0x0a,
	...
	0x0a, 0x68, 0x65, 0x61, 0x64, 0x69, 0x6d, 0x67, 0x75, 0x72, 0x6c, 0x18, 0x07, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x0a, 0x68, 0x65, 0x61, 0x64, 0x69, 0x6d, 0x67, 0x75, 0x72, 0x6c, 0x12, 0x1c, 0x0a,
	0x09, 0x70, 0x72, 0x69, 0x76, 0x69, 0x6c, 0x65, 0x67, 0x65, 0x18, 0x08, 0x20, 0x03, 0x28, 0x09,
	0x52, 0x09, 0x70, 0x72, 0x69, 0x76, 0x69, 0x6c, 0x65, 0x67, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x75,
	0x6e, 0x69, 0x6f, 0x6e, 0x69, 0x64, 0x18, 0x09, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x75, 0x6e,
	0x69, 0x6f, 0x6e, 0x69, 0x64, 0x22, 0xcc, 0x01, 0x0a, 0x0e, 0x41, 0x6c, 0x69, 0x70, 0x61, 0x79,
	0x55, 0x73, 0x65, 0x72, 0x69, 0x6e, 0x66, 0x6f, 0x12, 0x12, 0x0a, 0x04, 0x63, 0x6f, 0x64, 0x65,
	...
	0x1b, 0x0a, 0x09, 0x6e, 0x69, 0x63, 0x6b, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x07, 0x20, 0x01,
	...
	0x6e, 0x64, 0x65, 0x72, 0x22, 0x3e, 0x0a, 0x0c, 0x42, 0x61, 0x69, 0x64, 0x75, 0x43, 0x6f, 0x6e,
	0x63, 0x65, 0x70, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x6c, 0x65, 0x76, 0x65, 0x6c, 0x31, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x6c, 0x65, 0x76, 0x65, 0x6c, 0x31, 0x12, 0x16, 0x0a, 0x06,
	0x6c, 0x65, 0x76, 0x65, 0x6c, 0x32, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x6c, 0x65,
	0x76, 0x65, 0x6c, 0x32, 0x22, 0xb7, 0x02, 0x0a, 0x0b, 0x42, 0x61, 0x69, 0x64, 0x75, 0x45, 0x6e,
	0x74, 0x69, 0x74, 0x79, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x01,
	...
	,
	...
	0x64, 0x65, 0x73, 0x63, 0x12, 0x18, 0x0a, 0x07, 0x6d, 0x65, 0x6e, 0x74, 0x69, 0x6f, 0x6e, 0x18,
	0x0a, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x6e, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x67,
	0x0a, 0x11, 0x42, 0x61, 0x69, 0x64, 0x75, 0x57, 0x6f, 0x72, 0x64, 0x4c, 0x6f, 0x63, 0x61, 0x74,
	0x69, 0x6f, 0x6e, 0x12, 0x10, 0x0a, 0x03, 0x74, 0x6f, 0x70, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05,
	0x52, 0x03, 0x74, 0x6f, 0x70, 0x12, 0x12, 0x0a, 0x04, 0x6c, 0x65, 0x66, 0x74, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x05, 0x52, 0x04, 0x6c, 0x65, 0x66, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x77, 0x69, 0x64,
	...
	,
	...
	,
	...
	0x61, 0x74, 0x75, 0x73, 0x12, 0x30, 0x0a, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x18, 0x05,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x42, 0x61,
	0x69, 0x64, 0x75, 0x44, 0x6f, 0x63, 0x41, 0x6e, 0x61, 0x6c, 0x79, 0x73, 0x69, 0x73, 0x52, 0x06,
	0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x12, 0x1b, 0x0a, 0x09, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65,
	...
	,
	...
	0x10, 0x42, 0x61, 0x69, 0x64, 0x75, 0x49, 0x64, 0x63, 0x61, 0x72, 0x64, 0x49, 0x64, 0x65, 0x6e,
	0x74, 0x12, 0x21, 0x0a, 0x0c, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75,
	0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0b, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x53, 0x74,
	0x61, 0x74, 0x75, 0x73, 0x12, 0x16, 0x0a, 0x06, 0x69, 0x64, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x02,
	...
	,
	...
	0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x7e, 0x0a, 0x07, 0x55, 0x73, 0x65, 0x72, 0x4c,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x07, 0x6c, 0x6f, 0x67, 0x54, 0x79, 0x70, 0x65, 0x12,
	0x19, 0x0a, 0x08, 0x6c, 0x6f, 0x67, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x04, 0x20, 0x01, 0x28,
	...
	0x72, 0x65, 0x61, 0x74, 0x65, 0x41, 0x74, 0x22, 0xaa, 0x02, 0x0a, 0x08, 0x43, 0x72, 0x6f, 0x6e,
	0x49, 0x74, 0x65, 0x6d, 0x12, 0x1a, 0x0a, 0x08, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x76, 0x61, 0x6c,
	...
	,
	...
	0x3a, 0x02, 0x38, 0x01, 0x22, 0x98, 0x01, 0x0a, 0x07, 0x50, 0x6b, 0x67, 0x49, 0x74, 0x65, 0x6d,
	...
	,
	...
	,
	...
	,
	...
	0x70, 0x61, 0x79, 0x5f, 0x73, 0x74, 0x79, 0x6c, 0x65, 0x18, 0x09, 0x20, 0x01, 0x28, 0x03, 0x52,
	0x08, 0x70, 0x61, 0x79, 0x53, 0x74, 0x79, 0x6c, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x69, 0x6e, 0x66,
	0x6f, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x69, 0x6e, 0x66, 0x6f, 0x12, 0x14, 0x0a,
	...
	,
	...
	0x61, 0x74, 0x65, 0x64, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x0e, 0x61, 0x73, 0x73, 0x6f, 0x63, 0x69, 0x61, 0x74, 0x65, 0x64, 0x44, 0x61, 0x74, 0x61, 0x12,
	0x14, 0x0a, 0x05, 0x6e, 0x6f, 0x6e, 0x63, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05,
	0x6e, 0x6f, 0x6e, 0x63, 0x65, 0x22, 0xc9, 0x01, 0x0a, 0x08, 0x56, 0x69, 0x70, 0x50, 0x61, 0x79,
	0x43, 0x62, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02,
	...
	0x75, 0x72, 0x63, 0x65, 0x54, 0x79, 0x70, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x65, 0x76, 0x65, 0x6e,
	...
	0x79, 0x12, 0x2e, 0x0a, 0x08, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x18, 0x06, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x56, 0x69, 0x70,
	0x50, 0x61, 0x79, 0x43, 0x62, 0x52, 0x65, 0x52, 0x08, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63,
	0x65, 0x22, 0x6d, 0x0a, 0x09, 0x55, 0x73, 0x65, 0x72, 0x53, 0x63, 0x6f, 0x72, 0x65, 0x12, 0x10,
	...
	0x05, 0x73, 0x63, 0x6f, 0x72, 0x65, 0x12, 0x1b, 0x0a, 0x09, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65,
	0x5f, 0x61, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x63, 0x72, 0x65, 0x61, 0x74,
	0x65, 0x41, 0x74, 0x12, 0x1b, 0x0a, 0x09, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x5f, 0x61, 0x74,
	0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x41, 0x74,
	0x22, 0x98, 0x01, 0x0a, 0x07, 0x55, 0x73, 0x65, 0x72, 0x56, 0x69, 0x70, 0x12, 0x10, 0x0a, 0x03,
	...
	0x03, 0x52, 0x07, 0x69, 0x6e, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x12, 0x1b, 0x0a, 0x09, 0x63, 0x72,
	...
	,
	...
	,
	...
	,
	...
	0x01, 0x28, 0x03, 0x52, 0x03, 0x75, 0x69, 0x64, 0x12, 0x1a, 0x0a, 0x08, 0x74, 0x65, 0x6d, 0x70,
	0x6c, 0x61, 0x74, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x74, 0x65, 0x6d, 0x70,
	0x6c, 0x61, 0x74, 0x65, 0x12, 0x1b, 0x0a, 0x09, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x5f, 0x61,
	...
	0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x41, 0x74, 0x12, 0x35,
	0x0a, 0x05, 0x65, 0x78, 0x74, 0x72, 0x61, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1f, 0x2e,
	...
	0x78, 0x0a, 0x0f, 0x4d, 0x65, 0x47, 0x6f, 0x6f, 0x64, 0x73, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f,
	...
	0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x69, 0x63, 0x6f, 0x6e, 0x12, 0x1b, 0x0a, 0x09,
	0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x5f, 0x61, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x03, 0x52,
	0x08, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x41, 0x74, 0x22, 0x8c, 0x02, 0x0a, 0x07, 0x4d, 0x65,
	0x47, 0x6f, 0x6f, 0x64, 0x73, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x03, 0x52, 0x02, 0x69, 0x64, 0x12, 0x17, 0x0a, 0x07, 0x63, 0x61, 0x74, 0x65, 0x5f, 0x69, 0x64,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x63, 0x61, 0x74, 0x65, 0x49, 0x64, 0x12, 0x10,
	...
	,
	...
	0x10, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x41, 0x74, 0x12,
	0x31, 0x0a, 0x05, 0x65, 0x78, 0x74, 0x72, 0x61, 0x18, 0x11, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1b,
	...
	0x65, 0x73, 0x63, 0x12, 0x15, 0x0a, 0x06, 0x6e, 0x64, 0x5f, 0x75, 0x69, 0x64, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x03, 0x52, 0x05, 0x6e, 0x64, 0x55, 0x69, 0x64, 0x12, 0x15, 0x0a, 0x06, 0x61, 0x6e,
	0x5f, 0x75, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x61, 0x6e, 0x55, 0x69,
	0x64, 0x12, 0x15, 0x0a, 0x06, 0x6c, 0x6c, 0x5f, 0x69, 0x64, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x05, 0x6c, 0x6c, 0x49, 0x64, 0x73, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74,
	...
	,
	...
	0x73, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x37, 0x0a, 0x0b, 0x67, 0x61, 0x74, 0x68, 0x65,
	0x72, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x63,
	0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x4c, 0x65, 0x6e, 0x64, 0x4c, 0x6f, 0x61, 0x6e, 0x47, 0x61,
	0x74, 0x68, 0x65, 0x72, 0x52, 0x0a, 0x67, 0x61, 0x74, 0x68, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f,
	0x12, 0x2e, 0x0a, 0x09, 0x6c, 0x65, 0x6e, 0x64, 0x6c, 0x6f, 0x61, 0x6e, 0x73, 0x18, 0x05, 0x20,
	...
	0x22, 0x8d, 0x01, 0x0a, 0x08, 0x46, 0x65, 0x65, 0x64, 0x62, 0x61, 0x63, 0x6b, 0x12, 0x0e, 0x0a,
	...
	0x06, 0x6d, 0x6f, 0x62, 0x69, 0x6c, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x69, 0x6d, 0x61, 0x67, 0x65,
	...
	0x22, 0x1d, 0x0a, 0x09, 0x53, 0x68, 0x61, 0x72, 0x65, 0x56, 0x69, 0x73, 0x69, 0x12, 0x10, 0x0a,
	0x03, 0x75, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x03, 0x75, 0x69, 0x64, 0x22,
	0x91, 0x02, 0x0a, 0x08, 0x53, 0x74, 0x72, 0x61, 0x74, 0x65, 0x67, 0x79, 0x12, 0x28, 0x0a, 0x04,
	0x74, 0x79, 0x70, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x14, 0x2e, 0x63, 0x6f, 0x6d,
	0x6d, 0x6f, 0x6e, 0x2e, 0x53, 0x74, 0x72, 0x61, 0x74, 0x65, 0x67, 0x79, 0x54, 0x79, 0x70, 0x65,
	...
	0x52, 0x06, 0x64, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x12, 0x16, 0x0a, 0x06, 0x6e, 0x6f, 0x74, 0x69,
	0x66, 0x79, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x6e, 0x6f, 0x74, 0x69, 0x66, 0x79,
	0x12, 0x14, 0x0a, 0x05, 0x73, 0x74, 0x79, 0x6c, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x05, 0x73, 0x74, 0x79, 0x6c, 0x65, 0x12, 0x31, 0x0a, 0x05, 0x65, 0x78, 0x74, 0x72, 0x61, 0x18,
	0x07, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x53,
	0x74, 0x72, 0x61, 0x74, 0x65, 0x67, 0x79, 0x2e, 0x45, 0x78, 0x74, 0x72, 0x61, 0x45, 0x6e, 0x74,
	...
	,
	...
	,
	...
	0x73, 0x65, 0x72, 0x69, 0x6e, 0x66, 0x6f, 0x5f, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x5f, 0x55, 0x53,
	0x45, 0x52, 0x5f, 0x53, 0x45, 0x58, 0x10, 0x05, 0x2a, 0x2f, 0x0a, 0x09, 0x4c, 0x6f, 0x67, 0x69,
	0x6e, 0x54, 0x79, 0x70, 0x65, 0x12, 0x12, 0x0a, 0x0e, 0x6c, 0x6f, 0x67, 0x69, 0x6e, 0x5f, 0x70,
	0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x10, 0x00, 0x12, 0x0e, 0x0a, 0x0a, 0x6c, 0x6f, 0x67,
	0x69, 0x6e, 0x5f, 0x63, 0x6f, 0x64, 0x65, 0x10, 0x01, 0x2a, 0xbb, 0x02, 0x0a, 0x07, 0x4c, 0x6f,
	...
	,
...
var file_common_proto_goTypes = []interface{}{
	...
	(LendLoan_Status)(0),         // 9: common.LendLoan_Status
	(StrategyType)(0),            // 10: common.StrategyType
	(*Authorize)(nil),            // 11: common.Authorize
	(*Request)(nil),              // 12: common.Request
	(*Response)(nil),             // 13: common.Response
	(*UpdateUserinfoItem)(nil),   // 14: common.UpdateUserinfoItem
	(*UserInfo)(nil),             // 15: common.UserInfo
	(*WechatUserinfo)(nil),       // 16: common.WechatUserinfo
	(*AlipayUserinfo)(nil),       // 17: common.AlipayUserinfo
	(*BaiduConcept)(nil),         // 18: common.BaiduConcept
	(*BaiduEntity)(nil),          // 19: common.BaiduEntity
	(*BaiduWordLocation)(nil),    // 20: common.BaiduWordLocation
	(*BaiduLineProbability)(nil), // 21: common.BaiduLineProbability
	(*BaiduWordsItem)(nil),       // 22: common.BaiduWordsItem
	(*BaiduResultItem)(nil),      // 23: common.BaiduResultItem
	(*BaiduDocAnalysis)(nil),     // 24: common.BaiduDocAnalysis
	(*BaiduIdentItem)(nil),       // 25: common.BaiduIdentItem
	(*PersonCert)(nil),           // 26: common.PersonCert
	(*BaiduIdcardIdent)(nil),     // 27: common.BaiduIdcardIdent
	(*UserLog)(nil),              // 28: common.UserLog
	(*CronItem)(nil),             // 29: common.CronItem
	(*PkgItem)(nil),              // 30: common.PkgItem
	(*VipProduct)(nil),           // 31: common.VipProduct
	(*VipDesc)(nil),              // 32: common.VipDesc
	(*VipOrder)(nil),             // 33: common.VipOrder
	(*VipPayCbRe)(nil),           // 34: common.VipPayCbRe
	(*VipPayCb)(nil),             // 35: common.VipPayCb
	(*UserScore)(nil),            // 36: common.UserScore
	(*UserVip)(nil),              // 37: common.UserVip
	(*FootLog)(nil),              // 38: common.FootLog
	(*AlipayCb)(nil),             // 39: common.AlipayCb
	...
	(*LendLoan)(nil),             // 45: common.LendLoan
	(*LendLoanGather)(nil),       // 46: common.LendLoanGather
	(*Gather)(nil),               // 47: common.Gather
	(*Feedback)(nil),             // 48: common.Feedback
	(*ShareVisi)(nil),            // 49: common.ShareVisi
	(*Strategy)(nil),             // 50: common.Strategy
	(*GoodsTotal)(nil),           // 51: common.GoodsTotal
	nil,                          // 52: common.Authorize.ExtraEntry
	nil,                          // 53: common.Request.ExtraEntry
	nil,                          // 54: common.Response.ExtraEntry
	nil,                          // 55: common.UpdateUserinfoItem.ExtraEntry
	nil,                          // 56: common.PersonCert.ExtraEntry
	nil,                          // 57: common.BaiduIdcardIdent.ExtraEntry
	nil,                          // 58: common.CronItem.ExtraEntry
	nil,                          // 59: common.VipDesc.ExtraEntry
	nil,                          // 60: common.FootLog.ExtraEntry
	nil,                          // 61: common.TemplateItem.ExtraEntry
	nil,                          // 62: common.LendLoan.ExtraEntry
	nil,                          // 63: common.LendLoanGather.ExtraEntry
	nil,                          // 64: common.Strategy.ExtraEntry
	nil,                          // 65: common.GoodsTotal.ExtraEntry
}
var file_common_proto_depIdxs = []int32{
	52, // 0: common.Authorize.extra:type_name -> common.Authorize.ExtraEntry
	53, // 1: common.Request.extra:type_name -> common.Request.ExtraEntry
	54, // 2: common.Response.extra:type_name -> common.Response.ExtraEntry
	5,  // 3: common.UpdateUserinfoItem.field:type_name -> common.Update_userinfo_field
	55, // 4: common.UpdateUserinfoItem.extra:type_name -> common.UpdateUserinfoItem.ExtraEntry
	18, // 5: common.BaiduEntity.concept:type_name -> common.BaiduConcept
	20, // 6: common.BaiduWordsItem.location:type_name -> common.BaiduWordLocation
	21, // 7: common.BaiduWordsItem.probability:type_name -> common.BaiduLineProbability
	22, // 8: common.BaiduResultItem.word:type_name -> common.BaiduWordsItem
	23, // 9: common.BaiduDocAnalysis.results:type_name -> common.BaiduResultItem
	24, // 10: common.BaiduIdentItem.result:type_name -> common.BaiduDocAnalysis
	4,  // 11: common.PersonCert.cert_type:type_name -> common.CertType
	56, // 12: common.PersonCert.extra:type_name -> common.PersonCert.ExtraEntry
	57, // 13: common.BaiduIdcardIdent.extra:type_name -> common.BaiduIdcardIdent.ExtraEntry
	58, // 14: common.CronItem.extra:type_name -> common.CronItem.ExtraEntry
	59, // 15: common.VipDesc.extra:type_name -> common.VipDesc.ExtraEntry
	34, // 16: common.VipPayCb.resource:type_name -> common.VipPayCbRe
	60, // 17: common.FootLog.extra:type_name -> common.FootLog.ExtraEntry
	40, // 18: common.ShareItem.media:type_name -> common.ShareImage
	61, // 19: common.TemplateItem.extra:type_name -> common.TemplateItem.ExtraEntry
	40, // 20: common.MeGoods.media:type_name -> common.ShareImage
	40, // 21: common.LendLoan.images:type_name -> common.ShareImage
	62, // 22: common.LendLoan.extra:type_name -> common.LendLoan.ExtraEntry
	40, // 23: common.LendLoanGather.ret_images:type_name -> common.ShareImage
	63, // 24: common.LendLoanGather.extra:type_name -> common.LendLoanGather.ExtraEntry
	15, // 25: common.Gather.user_info:type_name -> common.UserInfo
	46, // 26: common.Gather.gather_info:type_name -> common.LendLoanGather
	45, // 27: common.Gather.lendloans:type_name -> common.LendLoan
	10, // 28: common.Strategy.type:type_name -> common.StrategyType
	64, // 29: common.Strategy.extra:type_name -> common.Strategy.ExtraEntry
	40, // 30: common.GoodsTotal.media:type_name -> common.ShareImage
	65, // 31: common.GoodsTotal.extra:type_name -> common.GoodsTotal.ExtraEntry
