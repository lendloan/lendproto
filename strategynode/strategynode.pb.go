...
func (x *VerifyReq) GetAuth() *common.Authorize {
	if x != nil {
		return x.Auth
	}
	return nil
...
func (x *VerifyReq) GetInfo() map[string]string {
	if x != nil {
		return x.Info
	}
	return nil
...
func (x *VerifyRes) GetRescode() rescode.Code {
	if x != nil {
		return x.Rescode
	}
	return rescode.Code(0)
...
func (x *VerifyRes) GetResmsg() string {
	if x != nil {
		return x.Resmsg
	}
	return ""
...
func (x *VerifyRes) GetExtra() map[string]string {
	if x != nil {
		return x.Extra
	}
	return nil
...
var file_strategynode_proto_rawDesc = []byte{
	...
	0x38, 0x01, 0x22, 0xb4, 0x01, 0x0a, 0x09, 0x56, 0x65, 0x72, 0x69, 0x66, 0x79, 0x52, 0x65, 0x71,
	...
	0x20, 0x01, 0x28, 0x03, 0x52, 0x03, 0x75, 0x69, 0x64, 0x12, 0x35, 0x0a, 0x04, 0x69, 0x6e, 0x66,
	0x6f, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x21, 0x2e, 0x73, 0x74, 0x72, 0x61, 0x74, 0x65,
	0x67, 0x79, 0x6e, 0x6f, 0x64, 0x65, 0x2e, 0x56, 0x65, 0x72, 0x69, 0x66, 0x79, 0x52, 0x65, 0x71,
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xc0, 0x01, 0x0a, 0x09, 0x56, 0x65,
	0x72, 0x69, 0x66, 0x79, 0x52, 0x65, 0x73, 0x12, 0x27, 0x0a, 0x07, 0x72, 0x65, 0x73, 0x63, 0x6f,
	...
	0x67, 0x79, 0x6e, 0x6f, 0x64, 0x65, 0x2e, 0x56, 0x65, 0x72, 0x69, 0x66, 0x79, 0x52, 0x65, 0x73,
	...
	,
...
var file_strategynode_proto_goTypes = []interface{}{
	...
	(*VerifyReq)(nil),        // 3: strategynode.VerifyReq
	(*VerifyRes)(nil),        // 4: strategynode.VerifyRes
	nil,                      // 5: strategynode.QueryReq.InfoEntry
	nil,                      // 6: strategynode.QueryRes.ExtraEntry
	nil,                      // 7: strategynode.VerifyReq.InfoEntry
	nil,                      // 8: strategynode.VerifyRes.ExtraEntry
	(*common.Authorize)(nil), // 9: common.Authorize
	(rescode.Code)(0),        // 10: rescode.Code
}
var file_strategynode_proto_depIdxs = []int32{
	9,  // 0: strategynode.QueryReq.auth:type_name -> common.Authorize
	5,  // 1: strategynode.QueryReq.info:type_name -> strategynode.QueryReq.InfoEntry
	10, // 2: strategynode.QueryRes.rescode:type_name -> rescode.Code
	0,  // 3: strategynode.QueryRes.strategy:type_name -> strategynode.Strategy
	6,  // 4: strategynode.QueryRes.extra:type_name -> strategynode.QueryRes.ExtraEntry
	9,  // 5: strategynode.VerifyReq.auth:type_name -> common.Authorize
	7,  // 6: strategynode.VerifyReq.info:type_name -> strategynode.VerifyReq.InfoEntry
	10, // 7: strategynode.VerifyRes.rescode:type_name -> rescode.Code
	8,  // 8: strategynode.VerifyRes.extra:type_name -> strategynode.VerifyRes.ExtraEntry
	1,  // 9: strategynode.StrategynodeService.Query:input_type -> strategynode.QueryReq
	3,  // 10: strategynode.StrategynodeService.Verify:input_type -> strategynode.VerifyReq
	2,  // 11: strategynode.StrategynodeService.Query:output_type -> strategynode.QueryRes
	4,  // 12: strategynode.StrategynodeService.Verify:output_type -> strategynode.VerifyRes
