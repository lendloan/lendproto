...
type LendLoanRes struct {
	...
	Rescode   rescode.Code       `protobuf:"varint,1,opt,name=rescode,proto3,enum=rescode.Code" json:"rescode,omitempty"`
	Resmsg    string             `protobuf:"bytes,2,opt,name=resmsg,proto3" json:"resmsg,omitempty"`
	Gather    *common.Gather     `protobuf:"bytes,3,opt,name=gather,proto3" json:"gather,omitempty"`
...
func (x *LendLoanRes) GetGather() *common.Gather {
	if x != nil {
		return x.Gather
	}
	return nil
...
var file_datanode_proto_rawDesc = []byte{
	...
	0x72, 0x65, 0x73, 0x63, 0x6f, 0x64, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x72, 0x65, 0x73, 0x6d, 0x73,
	0x67, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x72, 0x65, 0x73, 0x6d, 0x73, 0x67, 0x12,
	0x26, 0x0a, 0x06, 0x67, 0x61, 0x74, 0x68, 0x65, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x0e, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x47, 0x61, 0x74, 0x68, 0x65, 0x72, 0x52,
	...
	0xb8, 0x23, 0x0a, 0x0f, 0x44, 0x61, 0x74, 0x61, 0x6e, 0x6f, 0x64, 0x65, 0x53, 0x65, 0x72, 0x76,
...
var file_datanode_proto_depIdxs = []int32{
	...
	278, // 232: datanode.LendLoanRes.gather:type_name -> common.Gather
	...
	279, // 236: datanode.GatherStatusReq.status:type_name -> common.LendLoan_Status
	...
	279, // 241: datanode.LendLoanStatusReq.status:type_name -> common.LendLoan_Status
