...
var file_sharenode_proto_rawDesc = []byte{
	...
	,
...
var file_sharenode_proto_msgTypes = make([]protoimpl.MessageInfo, 20)
var file_sharenode_proto_goTypes = []interface{}{
	...
	nil,                         // 10: sharenode.AddShareReq.ExtraEntry
	nil,                         // 11: sharenode.AddShareRes.ExtraEntry
	nil,                         // 12: sharenode.UpdateShareReq.ExtraEntry
	nil,                         // 13: sharenode.UpdateShareRes.ExtraEntry
	nil,                         // 14: sharenode.QueryShareReq.ExtraEntry
	nil,                         // 15: sharenode.QueryShareRes.ExtraEntry
	nil,                         // 16: sharenode.UpdateTemplateReq.ExtraEntry
	nil,                         // 17: sharenode.UpdateTemplateRes.ExtraEntry
	nil,                         // 18: sharenode.QueryTemplateReq.ExtraEntry
	nil,                         // 19: sharenode.QueryTemplateRes.ExtraEntry
	(*common.ShareItem)(nil),    // 20: common.ShareItem
	(rescode.Code)(0),           // 21: rescode.Code
	(*common.TemplateItem)(nil), // 22: common.TemplateItem
}
var file_sharenode_proto_depIdxs = []int32{
	20, // 0: sharenode.AddShareReq.share:type_name -> common.ShareItem
	10, // 1: sharenode.AddShareReq.extra:type_name -> sharenode.AddShareReq.ExtraEntry
	21, // 2: sharenode.AddShareRes.rescode:type_name -> rescode.Code
	11, // 3: sharenode.AddShareRes.extra:type_name -> sharenode.AddShareRes.ExtraEntry
	20, // 4: sharenode.UpdateShareReq.share:type_name -> common.ShareItem
	12, // 5: sharenode.UpdateShareReq.extra:type_name -> sharenode.UpdateShareReq.ExtraEntry
	21, // 6: sharenode.UpdateShareRes.rescode:type_name -> rescode.Code
	13, // 7: sharenode.UpdateShareRes.extra:type_name -> sharenode.UpdateShareRes.ExtraEntry
	14, // 8: sharenode.QueryShareReq.extra:type_name -> sharenode.QueryShareReq.ExtraEntry
	21, // 9: sharenode.QueryShareRes.rescode:type_name -> rescode.Code
	20, // 10: sharenode.QueryShareRes.shares:type_name -> common.ShareItem
	15, // 11: sharenode.QueryShareRes.extra:type_name -> sharenode.QueryShareRes.ExtraEntry
	22, // 12: sharenode.UpdateTemplateReq.template:type_name -> common.TemplateItem
	16, // 13: sharenode.UpdateTemplateReq.extra:type_name -> sharenode.UpdateTemplateReq.ExtraEntry
	21, // 14: sharenode.UpdateTemplateRes.rescode:type_name -> rescode.Code
	17, // 15: sharenode.UpdateTemplateRes.extra:type_name -> sharenode.UpdateTemplateRes.ExtraEntry
	22, // 16: sharenode.QueryTemplateReq.template:type_name -> common.TemplateItem
	18, // 17: sharenode.QueryTemplateReq.extra:type_name -> sharenode.QueryTemplateReq.ExtraEntry
	21, // 18: sharenode.QueryTemplateRes.rescode:type_name -> rescode.Code
	22, // 19: sharenode.QueryTemplateRes.templates:type_name -> common.TemplateItem
	19, // 20: sharenode.QueryTemplateRes.extra:type_name -> sharenode.QueryTemplateRes.ExtraEntry
	0,  // 21: sharenode.SharenodeService.AddShare:input_type -> sharenode.AddShareReq
	2,  // 22: sharenode.SharenodeService.UpdateShare:input_type -> sharenode.UpdateShareReq
	4,  // 23: sharenode.SharenodeService.QueryShare:input_type -> sharenode.QueryShareReq
	6,  // 24: sharenode.SharenodeService.UpdateTemplate:input_type -> sharenode.UpdateTemplateReq
	8,  // 25: sharenode.SharenodeService.QueryTemplate:input_type -> sharenode.QueryTemplateReq
	1,  // 26: sharenode.SharenodeService.AddShare:output_type -> sharenode.AddShareRes
	3,  // 27: sharenode.SharenodeService.UpdateShare:output_type -> sharenode.UpdateShareRes
	5,  // 28: sharenode.SharenodeService.QueryShare:output_type -> sharenode.QueryShareRes
	7,  // 29: sharenode.SharenodeService.UpdateTemplate:output_type -> sharenode.UpdateTemplateRes
	9,  // 30: sharenode.SharenodeService.QueryTemplate:output_type -> sharenode.QueryTemplateRes
